...
fn ingest(
    ...
    let ks_opts = KeyspaceCreateOptions::default().max_memtable_size(memtable_size_mb * 1_024 * 1_024);
...
fn main() {
    ...
    match cli.command {
        Command::Ingest {
            ...
            journaling_size_mb,
            memtable_size_mb,
        } => ingest(&cli.db, &bin_file, limit, batch_size, journaling_size_mb, memtable_size_mb),
